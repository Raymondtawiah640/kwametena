...
// Helper function: split heading into wave spans
function WaveHeading({ text }) {
  return (
    <h1 className="text-4xl font-bold text-blue-600 mb-4 slide-in-heading">
...
function Home() {
  return (
    <div className="flex flex-col items-center justify-center bg-gray-100 w-full">
      {/* Hero Section */}
      <div className="hero-section flex flex-col md:flex-row items-center justify-center min-h-screen p-6 bg-gray-100 gap-8 w-full relative">
        {/* Left: Image */}
        <img
          src="/images/back.png"
          alt="Background"
        ...
        <div className="md:w-1/2 flex flex-col items-start">
          ...
          <WaveHeading text="Welcome to E-Learning" />

          <p className="text-gray-700 text-lg fade-in-text">
